...
if command -v module &> /dev/null || [ -n "$(type -t module)" ]; then
    ...
    module load gcc/11.4.0 2
    module load intel-oneapi-compilers/2025.0.4-gcc-11.4.0 2
    module load intel-oneapi-mpi/2021.14.1-oneapi-2025.0.4 2
    module load intel-oneapi-mkl/2024.2.2-intel-oneapi-mpi-2021.14.1-oneapi-2025.0.4 2
else
