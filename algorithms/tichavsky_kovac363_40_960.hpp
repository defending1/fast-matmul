...
# pragma omp parallel for if(!sequential)
    ...
    for (int j = 0; j < C.n(); ++j) {
        for (int i = 0; i < C.m(); ++i) {
            dataC[i + static_cast<size_t>(j) * strideC] = Scalar(-0.5) * dataS1[i + static_cast<size_t>(j) * strideS1] + Scalar(-0.5) * dataS2[i + static_cast<size_t>(j) * strideS2] + Scalar(0.5) * dataS3[i + static_cast<size_t>(j) * strideS3] + Scalar(-0.5) * dataS4[i + static_cast<size_t>(j) * strideS4] + Scalar(0.5) * dataS5[i + static_cast<size_t>(j) * strideS5] + Scalar(0.5) * dataS6[i + static_cast<size_t>(j) * strideS6] + Scalar(0.5) * dataS7[i + static_cast<size_t>(j) * strideS7] + Scalar(0.5) * dataS8[i + static_cast<size_t>(j) * strideS8] + Scalar(-0.5) * dataS9[i + static_cast<size_t>(j) * strideS9];
        }
    }
}
...
# pragma omp parallel for if(!sequential)
    ...
    for (int j = 0; j < C.n(); ++j) {
        for (int i = 0; i < C.m(); ++i) {
            dataC[i + static_cast<size_t>(j) * strideC] = Scalar(-0.5) * dataS1[i + static_cast<size_t>(j) * strideS1] + Scalar(-0.5) * dataS2[i + static_cast<size_t>(j) * strideS2] + Scalar(0.5) * dataS3[i + static_cast<size_t>(j) * strideS3] + Scalar(0.5) * dataS4[i + static_cast<size_t>(j) * strideS4] + Scalar(-0.5) * dataS5[i + static_cast<size_t>(j) * strideS5] + Scalar(0.5) * dataS6[i + static_cast<size_t>(j) * strideS6] + Scalar(-0.5) * dataS7[i + static_cast<size_t>(j) * strideS7] + Scalar(0.5) * dataS8[i + static_cast<size_t>(j) * strideS8] + Scalar(0.5) * dataS9[i + static_cast<size_t>(j) * strideS9] + Scalar(0.5) * dataS10[i + static_cast<size_t>(j) * strideS10];
        }
    }
}
...
# pragma omp parallel for if(!sequential)
        ...
        for (int j = 0; j < C.n(); ++j) {
            for (int i = 0; i < C.m(); ++i) {
                dataC[i + static_cast<size_t>(j) * strideC] = Scalar(0.5) * dataM1[i + static_cast<size_t>(j) * strideM1] + Scalar(0.5) * dataM2[i + static_cast<size_t>(j) * strideM2] + Scalar(-0.5) * dataM3[i + static_cast<size_t>(j) * strideM3] + Scalar(-0.5) * dataM4[i + static_cast<size_t>(j) * strideM4] + Scalar(0.5) * dataM5[i + static_cast<size_t>(j) * strideM5] + Scalar(-0.5) * dataM6[i + static_cast<size_t>(j) * strideM6] + Scalar(-0.5) * dataM7[i + static_cast<size_t>(j) * strideM7] + Scalar(0.5) * dataM8[i + static_cast<size_t>(j) * strideM8] + Scalar(-0.5) * dataM9[i + static_cast<size_t>(j) * strideM9] + Scalar(-0.5) * dataM10[i + static_cast<size_t>(j) * strideM10] + Scalar(0.5) * dataM11[i + static_cast<size_t>(j) * strideM11] + Scalar(0.5) * dataM12[i + static_cast<size_t>(j) * strideM12] + Scalar(-0.5) * dataM13[i + static_cast<size_t>(j) * strideM13] + Scalar(-0.5) * dataM14[i + static_cast<size_t>(j) * strideM14] + Scalar(-0.5) * dataM15[i + static_cast<size_t>(j) * strideM15] + Scalar(0.5) * dataM16[i + static_cast<size_t>(j) * strideM16] + Scalar(0.5) * dataM17[i + static_cast<size_t>(j) * strideM17] + Scalar(-0.5) * dataM18[i + static_cast<size_t>(j) * strideM18] + Scalar(-0.5) * dataM19[i + static_cast<size_t>(j) * strideM19] + Scalar(-0.5) * dataM20[i + static_cast<size_t>(j) * strideM20] + Scalar(0.5) * dataM21[i + static_cast<size_t>(j) * strideM21] + Scalar(-0.5) * dataM22[i + static_cast<size_t>(j) * strideM22] + Scalar(0.5) * dataM23[i + static_cast<size_t>(j) * strideM23] + Scalar(0.5) * dataM24[i + static_cast<size_t>(j) * strideM24] + Scalar(0.5) * dataM25[i + static_cast<size_t>(j) * strideM25] + Scalar(0.5) * dataM26[i + static_cast<size_t>(j) * strideM26] + Scalar(0.5) * dataM27[i + static_cast<size_t>(j) * strideM27] + Scalar(-0.5) * dataM28[i + static_cast<size_t>(j) * strideM28] + beta * dataC[i + static_cast<size_t>(j) * strideC];
            }
        }
    } else {
#ifdef _PARALLEL_
# pragma omp parallel for if(!sequential)
        ...
        for (int j = 0; j < C.n(); ++j) {
            for (int i = 0; i < C.m(); ++i) {
                dataC[i + static_cast<size_t>(j) * strideC] = Scalar(0.5) * dataM1[i + static_cast<size_t>(j) * strideM1] + Scalar(0.5) * dataM2[i + static_cast<size_t>(j) * strideM2] + Scalar(-0.5) * dataM3[i + static_cast<size_t>(j) * strideM3] + Scalar(-0.5) * dataM4[i + static_cast<size_t>(j) * strideM4] + Scalar(0.5) * dataM5[i + static_cast<size_t>(j) * strideM5] + Scalar(-0.5) * dataM6[i + static_cast<size_t>(j) * strideM6] + Scalar(-0.5) * dataM7[i + static_cast<size_t>(j) * strideM7] + Scalar(0.5) * dataM8[i + static_cast<size_t>(j) * strideM8] + Scalar(-0.5) * dataM9[i + static_cast<size_t>(j) * strideM9] + Scalar(-0.5) * dataM10[i + static_cast<size_t>(j) * strideM10] + Scalar(0.5) * dataM11[i + static_cast<size_t>(j) * strideM11] + Scalar(0.5) * dataM12[i + static_cast<size_t>(j) * strideM12] + Scalar(-0.5) * dataM13[i + static_cast<size_t>(j) * strideM13] + Scalar(-0.5) * dataM14[i + static_cast<size_t>(j) * strideM14] + Scalar(-0.5) * dataM15[i + static_cast<size_t>(j) * strideM15] + Scalar(0.5) * dataM16[i + static_cast<size_t>(j) * strideM16] + Scalar(0.5) * dataM17[i + static_cast<size_t>(j) * strideM17] + Scalar(-0.5) * dataM18[i + static_cast<size_t>(j) * strideM18] + Scalar(-0.5) * dataM19[i + static_cast<size_t>(j) * strideM19] + Scalar(-0.5) * dataM20[i + static_cast<size_t>(j) * strideM20] + Scalar(0.5) * dataM21[i + static_cast<size_t>(j) * strideM21] + Scalar(-0.5) * dataM22[i + static_cast<size_t>(j) * strideM22] + Scalar(0.5) * dataM23[i + static_cast<size_t>(j) * strideM23] + Scalar(0.5) * dataM24[i + static_cast<size_t>(j) * strideM24] + Scalar(0.5) * dataM25[i + static_cast<size_t>(j) * strideM25] + Scalar(0.5) * dataM26[i + static_cast<size_t>(j) * strideM26] + Scalar(0.5) * dataM27[i + static_cast<size_t>(j) * strideM27] + Scalar(-0.5) * dataM28[i + static_cast<size_t>(j) * strideM28];
            }
        }
    }
}
...
# pragma omp parallel for if(!sequential)
        ...
        for (int j = 0; j < C.n(); ++j) {
            for (int i = 0; i < C.m(); ++i) {
                dataC[i + static_cast<size_t>(j) * strideC] = Scalar(0.5) * dataM1[i + static_cast<size_t>(j) * strideM1] + Scalar(0.5) * dataM2[i + static_cast<size_t>(j) * strideM2] + Scalar(0.5) * dataM3[i + static_cast<size_t>(j) * strideM3] + Scalar(-0.5) * dataM4[i + static_cast<size_t>(j) * strideM4] + Scalar(-0.5) * dataM5[i + static_cast<size_t>(j) * strideM5] + Scalar(0.5) * dataM6[i + static_cast<size_t>(j) * strideM6] + Scalar(0.5) * dataM7[i + static_cast<size_t>(j) * strideM7] + Scalar(-0.5) * dataM8[i + static_cast<size_t>(j) * strideM8] + beta * dataC[i + static_cast<size_t>(j) * strideC];
            }
        }
    } else {
#ifdef _PARALLEL_
# pragma omp parallel for if(!sequential)
        ...
        for (int j = 0; j < C.n(); ++j) {
            for (int i = 0; i < C.m(); ++i) {
                dataC[i + static_cast<size_t>(j) * strideC] = Scalar(0.5) * dataM1[i + static_cast<size_t>(j) * strideM1] + Scalar(0.5) * dataM2[i + static_cast<size_t>(j) * strideM2] + Scalar(0.5) * dataM3[i + static_cast<size_t>(j) * strideM3] + Scalar(-0.5) * dataM4[i + static_cast<size_t>(j) * strideM4] + Scalar(-0.5) * dataM5[i + static_cast<size_t>(j) * strideM5] + Scalar(0.5) * dataM6[i + static_cast<size_t>(j) * strideM6] + Scalar(0.5) * dataM7[i + static_cast<size_t>(j) * strideM7] + Scalar(-0.5) * dataM8[i + static_cast<size_t>(j) * strideM8];
            }
        }
    }
}
