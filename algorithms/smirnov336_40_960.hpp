...
# pragma omp parallel for if(!sequential)
    ...
    for (int j = 0; j < C.n(); ++j) {
        for (int i = 0; i < C.m(); ++i) {
            dataC[i + static_cast<size_t>(j) * strideC] = Scalar(-0.125) * dataT1[i + static_cast<size_t>(j) * strideT1] + dataT2[i + static_cast<size_t>(j) * strideT2] + Scalar(0.125) * dataT3[i + static_cast<size_t>(j) * strideT3] + Scalar(0.125) * dataT4[i + static_cast<size_t>(j) * strideT4] + Scalar(0.125) * dataT5[i + static_cast<size_t>(j) * strideT5] -dataT6[i + static_cast<size_t>(j) * strideT6] -dataT7[i + static_cast<size_t>(j) * strideT7] + Scalar(0.125) * dataT8[i + static_cast<size_t>(j) * strideT8] + Scalar(0.125) * dataT9[i + static_cast<size_t>(j) * strideT9];
        }
    }
}
...
# pragma omp parallel for if(!sequential)
    ...
    for (int j = 0; j < C.n(); ++j) {
        for (int i = 0; i < C.m(); ++i) {
            dataC[i + static_cast<size_t>(j) * strideC] = Scalar(-0.125) * dataT1[i + static_cast<size_t>(j) * strideT1] + Scalar(-0.125) * dataT2[i + static_cast<size_t>(j) * strideT2] -dataT3[i + static_cast<size_t>(j) * strideT3] + Scalar(0.125) * dataT4[i + static_cast<size_t>(j) * strideT4] + dataT5[i + static_cast<size_t>(j) * strideT5] + Scalar(-0.125) * dataT6[i + static_cast<size_t>(j) * strideT6] -dataT7[i + static_cast<size_t>(j) * strideT7] + Scalar(-0.125) * dataT8[i + static_cast<size_t>(j) * strideT8] + Scalar(0.125) * dataT9[i + static_cast<size_t>(j) * strideT9];
        }
    }
}
...
# pragma omp parallel for if(!sequential)
    ...
    for (int j = 0; j < C.n(); ++j) {
        for (int i = 0; i < C.m(); ++i) {
            dataC[i + static_cast<size_t>(j) * strideC] = -dataT1[i + static_cast<size_t>(j) * strideT1] + Scalar(0.125) * dataT2[i + static_cast<size_t>(j) * strideT2] + Scalar(-0.125) * dataT3[i + static_cast<size_t>(j) * strideT3] -dataT4[i + static_cast<size_t>(j) * strideT4] + Scalar(0.125) * dataT5[i + static_cast<size_t>(j) * strideT5] + Scalar(0.125) * dataT6[i + static_cast<size_t>(j) * strideT6] + Scalar(-0.125) * dataT7[i + static_cast<size_t>(j) * strideT7] + dataT8[i + static_cast<size_t>(j) * strideT8] + Scalar(-0.125) * dataT9[i + static_cast<size_t>(j) * strideT9];
        }
    }
}
...
# pragma omp parallel for if(!sequential)
    ...
    for (int j = 0; j < C.n(); ++j) {
        for (int i = 0; i < C.m(); ++i) {
            dataC[i + static_cast<size_t>(j) * strideC] = -dataT1[i + static_cast<size_t>(j) * strideT1] + Scalar(-0.125) * dataT2[i + static_cast<size_t>(j) * strideT2] + Scalar(0.125) * dataT3[i + static_cast<size_t>(j) * strideT3] + dataT4[i + static_cast<size_t>(j) * strideT4] + Scalar(0.125) * dataT5[i + static_cast<size_t>(j) * strideT5] + Scalar(0.125) * dataT6[i + static_cast<size_t>(j) * strideT6] + Scalar(-0.125) * dataT7[i + static_cast<size_t>(j) * strideT7] + Scalar(-0.125) * dataT8[i + static_cast<size_t>(j) * strideT8] -dataT9[i + static_cast<size_t>(j) * strideT9];
        }
    }
}
...
# pragma omp parallel for if(!sequential)
    ...
    for (int j = 0; j < C.n(); ++j) {
        for (int i = 0; i < C.m(); ++i) {
            dataC[i + static_cast<size_t>(j) * strideC] = -dataT1[i + static_cast<size_t>(j) * strideT1] + Scalar(-0.125) * dataT2[i + static_cast<size_t>(j) * strideT2] + Scalar(0.125) * dataT3[i + static_cast<size_t>(j) * strideT3] + Scalar(-0.125) * dataT4[i + static_cast<size_t>(j) * strideT4] + dataT5[i + static_cast<size_t>(j) * strideT5] + Scalar(-0.125) * dataT6[i + static_cast<size_t>(j) * strideT6] -dataT7[i + static_cast<size_t>(j) * strideT7] + dataT8[i + static_cast<size_t>(j) * strideT8] + Scalar(0.125) * dataT9[i + static_cast<size_t>(j) * strideT9] + Scalar(-0.125) * dataT10[i + static_cast<size_t>(j) * strideT10];
        }
    }
}
...
# pragma omp parallel for if(!sequential)
    ...
    for (int j = 0; j < C.n(); ++j) {
        for (int i = 0; i < C.m(); ++i) {
            dataC[i + static_cast<size_t>(j) * strideC] = -dataT1[i + static_cast<size_t>(j) * strideT1] -dataT2[i + static_cast<size_t>(j) * strideT2] -dataT3[i + static_cast<size_t>(j) * strideT3] + Scalar(0.125) * dataT4[i + static_cast<size_t>(j) * strideT4] + Scalar(-0.125) * dataT5[i + static_cast<size_t>(j) * strideT5] + Scalar(0.125) * dataT6[i + static_cast<size_t>(j) * strideT6] -dataT7[i + static_cast<size_t>(j) * strideT7] + Scalar(0.125) * dataT8[i + static_cast<size_t>(j) * strideT8] + Scalar(-0.125) * dataT9[i + static_cast<size_t>(j) * strideT9] + Scalar(-0.125) * dataT10[i + static_cast<size_t>(j) * strideT10];
        }
    }
}
...
# pragma omp parallel for if(!sequential)
    ...
    for (int j = 0; j < C.n(); ++j) {
        for (int i = 0; i < C.m(); ++i) {
            dataC[i + static_cast<size_t>(j) * strideC] = Scalar(0.125) * dataT1[i + static_cast<size_t>(j) * strideT1] + Scalar(0.125) * dataT2[i + static_cast<size_t>(j) * strideT2] + Scalar(-0.125) * dataT3[i + static_cast<size_t>(j) * strideT3] + Scalar(0.125) * dataT4[i + static_cast<size_t>(j) * strideT4] + dataT5[i + static_cast<size_t>(j) * strideT5] + Scalar(0.125) * dataT6[i + static_cast<size_t>(j) * strideT6] + Scalar(-0.125) * dataT7[i + static_cast<size_t>(j) * strideT7] + Scalar(-0.125) * dataT8[i + static_cast<size_t>(j) * strideT8] -dataT9[i + static_cast<size_t>(j) * strideT9] + Scalar(0.125) * dataT10[i + static_cast<size_t>(j) * strideT10];
        }
    }
}
...
# pragma omp parallel for if(!sequential)
        ...
        for (int j = 0; j < C.n(); ++j) {
            for (int i = 0; i < C.m(); ++i) {
                dataC[i + static_cast<size_t>(j) * strideC] = Scalar(-0.125) * dataM1[i + static_cast<size_t>(j) * strideM1] + Scalar(0.125) * dataM2[i + static_cast<size_t>(j) * strideM2] + Scalar(-0.125) * dataM3[i + static_cast<size_t>(j) * strideM3] + Scalar(-0.125) * dataM4[i + static_cast<size_t>(j) * strideM4] + Scalar(0.125) * dataM5[i + static_cast<size_t>(j) * strideM5] + Scalar(-0.125) * dataM6[i + static_cast<size_t>(j) * strideM6] + Scalar(-0.125) * dataM7[i + static_cast<size_t>(j) * strideM7] + Scalar(-0.125) * dataM8[i + static_cast<size_t>(j) * strideM8] + Scalar(-0.125) * dataM9[i + static_cast<size_t>(j) * strideM9] + Scalar(-0.125) * dataM10[i + static_cast<size_t>(j) * strideM10] + Scalar(0.125) * dataM11[i + static_cast<size_t>(j) * strideM11] + Scalar(0.125) * dataM12[i + static_cast<size_t>(j) * strideM12] + Scalar(-0.125) * dataM13[i + static_cast<size_t>(j) * strideM13] + Scalar(-0.125) * dataM14[i + static_cast<size_t>(j) * strideM14] + Scalar(-0.125) * dataM15[i + static_cast<size_t>(j) * strideM15] + Scalar(-0.125) * dataM16[i + static_cast<size_t>(j) * strideM16] + Scalar(-0.125) * dataM17[i + static_cast<size_t>(j) * strideM17] + Scalar(0.125) * dataM18[i + static_cast<size_t>(j) * strideM18] + Scalar(-0.125) * dataM19[i + static_cast<size_t>(j) * strideM19] + Scalar(-0.125) * dataM20[i + static_cast<size_t>(j) * strideM20] + Scalar(0.125) * dataM21[i + static_cast<size_t>(j) * strideM21] + Scalar(0.125) * dataM22[i + static_cast<size_t>(j) * strideM22] + Scalar(0.125) * dataM23[i + static_cast<size_t>(j) * strideM23] + Scalar(0.125) * dataM24[i + static_cast<size_t>(j) * strideM24] + beta * dataC[i + static_cast<size_t>(j) * strideC];
            }
        }
    } else {
#ifdef _PARALLEL_
# pragma omp parallel for if(!sequential)
        ...
        for (int j = 0; j < C.n(); ++j) {
            for (int i = 0; i < C.m(); ++i) {
                dataC[i + static_cast<size_t>(j) * strideC] = Scalar(-0.125) * dataM1[i + static_cast<size_t>(j) * strideM1] + Scalar(0.125) * dataM2[i + static_cast<size_t>(j) * strideM2] + Scalar(-0.125) * dataM3[i + static_cast<size_t>(j) * strideM3] + Scalar(-0.125) * dataM4[i + static_cast<size_t>(j) * strideM4] + Scalar(0.125) * dataM5[i + static_cast<size_t>(j) * strideM5] + Scalar(-0.125) * dataM6[i + static_cast<size_t>(j) * strideM6] + Scalar(-0.125) * dataM7[i + static_cast<size_t>(j) * strideM7] + Scalar(-0.125) * dataM8[i + static_cast<size_t>(j) * strideM8] + Scalar(-0.125) * dataM9[i + static_cast<size_t>(j) * strideM9] + Scalar(-0.125) * dataM10[i + static_cast<size_t>(j) * strideM10] + Scalar(0.125) * dataM11[i + static_cast<size_t>(j) * strideM11] + Scalar(0.125) * dataM12[i + static_cast<size_t>(j) * strideM12] + Scalar(-0.125) * dataM13[i + static_cast<size_t>(j) * strideM13] + Scalar(-0.125) * dataM14[i + static_cast<size_t>(j) * strideM14] + Scalar(-0.125) * dataM15[i + static_cast<size_t>(j) * strideM15] + Scalar(-0.125) * dataM16[i + static_cast<size_t>(j) * strideM16] + Scalar(-0.125) * dataM17[i + static_cast<size_t>(j) * strideM17] + Scalar(0.125) * dataM18[i + static_cast<size_t>(j) * strideM18] + Scalar(-0.125) * dataM19[i + static_cast<size_t>(j) * strideM19] + Scalar(-0.125) * dataM20[i + static_cast<size_t>(j) * strideM20] + Scalar(0.125) * dataM21[i + static_cast<size_t>(j) * strideM21] + Scalar(0.125) * dataM22[i + static_cast<size_t>(j) * strideM22] + Scalar(0.125) * dataM23[i + static_cast<size_t>(j) * strideM23] + Scalar(0.125) * dataM24[i + static_cast<size_t>(j) * strideM24];
            }
        }
    }
}
...
# pragma omp parallel for if(!sequential)
        ...
        for (int j = 0; j < C.n(); ++j) {
            for (int i = 0; i < C.m(); ++i) {
                dataC[i + static_cast<size_t>(j) * strideC] = -dataM1[i + static_cast<size_t>(j) * strideM1] + dataM2[i + static_cast<size_t>(j) * strideM2] + dataM3[i + static_cast<size_t>(j) * strideM3] + dataM4[i + static_cast<size_t>(j) * strideM4] -dataM5[i + static_cast<size_t>(j) * strideM5] + dataM6[i + static_cast<size_t>(j) * strideM6] + dataM7[i + static_cast<size_t>(j) * strideM7] -dataM8[i + static_cast<size_t>(j) * strideM8] + dataM9[i + static_cast<size_t>(j) * strideM9] + dataM10[i + static_cast<size_t>(j) * strideM10] + dataM11[i + static_cast<size_t>(j) * strideM11] -dataM12[i + static_cast<size_t>(j) * strideM12] -dataM13[i + static_cast<size_t>(j) * strideM13] -dataM14[i + static_cast<size_t>(j) * strideM14] + dataM15[i + static_cast<size_t>(j) * strideM15] + dataM16[i + static_cast<size_t>(j) * strideM16] + dataM17[i + static_cast<size_t>(j) * strideM17] + dataM18[i + static_cast<size_t>(j) * strideM18] + dataM19[i + static_cast<size_t>(j) * strideM19] -dataM20[i + static_cast<size_t>(j) * strideM20] + dataM21[i + static_cast<size_t>(j) * strideM21] + dataM22[i + static_cast<size_t>(j) * strideM22] -dataM23[i + static_cast<size_t>(j) * strideM23] -dataM24[i + static_cast<size_t>(j) * strideM24] + beta * dataC[i + static_cast<size_t>(j) * strideC];
            }
        }
    } else {
#ifdef _PARALLEL_
# pragma omp parallel for if(!sequential)
        ...
        for (int j = 0; j < C.n(); ++j) {
            for (int i = 0; i < C.m(); ++i) {
                dataC[i + static_cast<size_t>(j) * strideC] = -dataM1[i + static_cast<size_t>(j) * strideM1] + dataM2[i + static_cast<size_t>(j) * strideM2] + dataM3[i + static_cast<size_t>(j) * strideM3] + dataM4[i + static_cast<size_t>(j) * strideM4] -dataM5[i + static_cast<size_t>(j) * strideM5] + dataM6[i + static_cast<size_t>(j) * strideM6] + dataM7[i + static_cast<size_t>(j) * strideM7] -dataM8[i + static_cast<size_t>(j) * strideM8] + dataM9[i + static_cast<size_t>(j) * strideM9] + dataM10[i + static_cast<size_t>(j) * strideM10] + dataM11[i + static_cast<size_t>(j) * strideM11] -dataM12[i + static_cast<size_t>(j) * strideM12] -dataM13[i + static_cast<size_t>(j) * strideM13] -dataM14[i + static_cast<size_t>(j) * strideM14] + dataM15[i + static_cast<size_t>(j) * strideM15] + dataM16[i + static_cast<size_t>(j) * strideM16] + dataM17[i + static_cast<size_t>(j) * strideM17] + dataM18[i + static_cast<size_t>(j) * strideM18] + dataM19[i + static_cast<size_t>(j) * strideM19] -dataM20[i + static_cast<size_t>(j) * strideM20] + dataM21[i + static_cast<size_t>(j) * strideM21] + dataM22[i + static_cast<size_t>(j) * strideM22] -dataM23[i + static_cast<size_t>(j) * strideM23] -dataM24[i + static_cast<size_t>(j) * strideM24];
            }
        }
    }
}
...
# pragma omp parallel for if(!sequential)
        ...
        for (int j = 0; j < C.n(); ++j) {
            for (int i = 0; i < C.m(); ++i) {
                dataC[i + static_cast<size_t>(j) * strideC] = -dataM1[i + static_cast<size_t>(j) * strideM1] + dataM2[i + static_cast<size_t>(j) * strideM2] -dataM3[i + static_cast<size_t>(j) * strideM3] + dataM4[i + static_cast<size_t>(j) * strideM4] + dataM5[i + static_cast<size_t>(j) * strideM5] -dataM6[i + static_cast<size_t>(j) * strideM6] -dataM7[i + static_cast<size_t>(j) * strideM7] -dataM8[i + static_cast<size_t>(j) * strideM8] + dataM9[i + static_cast<size_t>(j) * strideM9] + dataM10[i + static_cast<size_t>(j) * strideM10] + dataM11[i + static_cast<size_t>(j) * strideM11] + dataM12[i + static_cast<size_t>(j) * strideM12] -dataM13[i + static_cast<size_t>(j) * strideM13] + dataM14[i + static_cast<size_t>(j) * strideM14] -dataM15[i + static_cast<size_t>(j) * strideM15] + dataM16[i + static_cast<size_t>(j) * strideM16] + beta * dataC[i + static_cast<size_t>(j) * strideC];
            }
        }
    } else {
#ifdef _PARALLEL_
# pragma omp parallel for if(!sequential)
        ...
        for (int j = 0; j < C.n(); ++j) {
            for (int i = 0; i < C.m(); ++i) {
                dataC[i + static_cast<size_t>(j) * strideC] = -dataM1[i + static_cast<size_t>(j) * strideM1] + dataM2[i + static_cast<size_t>(j) * strideM2] -dataM3[i + static_cast<size_t>(j) * strideM3] + dataM4[i + static_cast<size_t>(j) * strideM4] + dataM5[i + static_cast<size_t>(j) * strideM5] -dataM6[i + static_cast<size_t>(j) * strideM6] -dataM7[i + static_cast<size_t>(j) * strideM7] -dataM8[i + static_cast<size_t>(j) * strideM8] + dataM9[i + static_cast<size_t>(j) * strideM9] + dataM10[i + static_cast<size_t>(j) * strideM10] + dataM11[i + static_cast<size_t>(j) * strideM11] + dataM12[i + static_cast<size_t>(j) * strideM12] -dataM13[i + static_cast<size_t>(j) * strideM13] + dataM14[i + static_cast<size_t>(j) * strideM14] -dataM15[i + static_cast<size_t>(j) * strideM15] + dataM16[i + static_cast<size_t>(j) * strideM16];
            }
        }
    }
}
...
# pragma omp parallel for if(!sequential)
        ...
        for (int j = 0; j < C.n(); ++j) {
            for (int i = 0; i < C.m(); ++i) {
                dataC[i + static_cast<size_t>(j) * strideC] = Scalar(-0.125) * dataM1[i + static_cast<size_t>(j) * strideM1] + Scalar(0.125) * dataM2[i + static_cast<size_t>(j) * strideM2] + Scalar(0.125) * dataM3[i + static_cast<size_t>(j) * strideM3] + Scalar(-0.125) * dataM4[i + static_cast<size_t>(j) * strideM4] + Scalar(-0.125) * dataM5[i + static_cast<size_t>(j) * strideM5] + Scalar(-0.125) * dataM6[i + static_cast<size_t>(j) * strideM6] + Scalar(-0.125) * dataM7[i + static_cast<size_t>(j) * strideM7] + Scalar(0.125) * dataM8[i + static_cast<size_t>(j) * strideM8] + Scalar(0.125) * dataM9[i + static_cast<size_t>(j) * strideM9] + Scalar(0.125) * dataM10[i + static_cast<size_t>(j) * strideM10] + Scalar(0.125) * dataM11[i + static_cast<size_t>(j) * strideM11] + Scalar(-0.125) * dataM12[i + static_cast<size_t>(j) * strideM12] + Scalar(0.125) * dataM13[i + static_cast<size_t>(j) * strideM13] + Scalar(-0.125) * dataM14[i + static_cast<size_t>(j) * strideM14] + Scalar(0.125) * dataM15[i + static_cast<size_t>(j) * strideM15] + Scalar(0.125) * dataM16[i + static_cast<size_t>(j) * strideM16] + beta * dataC[i + static_cast<size_t>(j) * strideC];
            }
        }
    } else {
#ifdef _PARALLEL_
# pragma omp parallel for if(!sequential)
        ...
        for (int j = 0; j < C.n(); ++j) {
            for (int i = 0; i < C.m(); ++i) {
                dataC[i + static_cast<size_t>(j) * strideC] = Scalar(-0.125) * dataM1[i + static_cast<size_t>(j) * strideM1] + Scalar(0.125) * dataM2[i + static_cast<size_t>(j) * strideM2] + Scalar(0.125) * dataM3[i + static_cast<size_t>(j) * strideM3] + Scalar(-0.125) * dataM4[i + static_cast<size_t>(j) * strideM4] + Scalar(-0.125) * dataM5[i + static_cast<size_t>(j) * strideM5] + Scalar(-0.125) * dataM6[i + static_cast<size_t>(j) * strideM6] + Scalar(-0.125) * dataM7[i + static_cast<size_t>(j) * strideM7] + Scalar(0.125) * dataM8[i + static_cast<size_t>(j) * strideM8] + Scalar(0.125) * dataM9[i + static_cast<size_t>(j) * strideM9] + Scalar(0.125) * dataM10[i + static_cast<size_t>(j) * strideM10] + Scalar(0.125) * dataM11[i + static_cast<size_t>(j) * strideM11] + Scalar(-0.125) * dataM12[i + static_cast<size_t>(j) * strideM12] + Scalar(0.125) * dataM13[i + static_cast<size_t>(j) * strideM13] + Scalar(-0.125) * dataM14[i + static_cast<size_t>(j) * strideM14] + Scalar(0.125) * dataM15[i + static_cast<size_t>(j) * strideM15] + Scalar(0.125) * dataM16[i + static_cast<size_t>(j) * strideM16];
            }
        }
    }
}
