...
# pragma omp parallel for if(!sequential)
    ...
    for (int j = 0; j < C.n(); ++j) {
        for (int i = 0; i < C.m(); ++i) {
            dataC[i + static_cast<size_t>(j) * strideC] = Scalar(0.5) * dataS1[i + static_cast<size_t>(j) * strideS1] + Scalar(0.5) * dataS2[i + static_cast<size_t>(j) * strideS2] + Scalar(0.5) * dataS3[i + static_cast<size_t>(j) * strideS3] + Scalar(0.5) * dataS4[i + static_cast<size_t>(j) * strideS4] + Scalar(-0.5) * dataS5[i + static_cast<size_t>(j) * strideS5] + Scalar(0.5) * dataS6[i + static_cast<size_t>(j) * strideS6];
        }
    }
}
...
# pragma omp parallel for if(!sequential)
    ...
    for (int j = 0; j < C.n(); ++j) {
        for (int i = 0; i < C.m(); ++i) {
            dataC[i + static_cast<size_t>(j) * strideC] = Scalar(-0.5) * dataS1[i + static_cast<size_t>(j) * strideS1] + Scalar(-0.5) * dataS2[i + static_cast<size_t>(j) * strideS2] + Scalar(-0.5) * dataS3[i + static_cast<size_t>(j) * strideS3] + Scalar(-0.5) * dataS4[i + static_cast<size_t>(j) * strideS4];
        }
    }
}
...
# pragma omp parallel for if(!sequential)
    ...
    for (int j = 0; j < C.n(); ++j) {
        for (int i = 0; i < C.m(); ++i) {
            dataC[i + static_cast<size_t>(j) * strideC] = Scalar(-0.5) * dataT1[i + static_cast<size_t>(j) * strideT1] + Scalar(0.5) * dataT2[i + static_cast<size_t>(j) * strideT2] + Scalar(0.5) * dataT3[i + static_cast<size_t>(j) * strideT3] + Scalar(0.5) * dataT4[i + static_cast<size_t>(j) * strideT4] + Scalar(0.5) * dataT5[i + static_cast<size_t>(j) * strideT5] + Scalar(-0.5) * dataT6[i + static_cast<size_t>(j) * strideT6] + Scalar(-0.5) * dataT7[i + static_cast<size_t>(j) * strideT7] + Scalar(0.5) * dataT8[i + static_cast<size_t>(j) * strideT8] + Scalar(0.5) * dataT9[i + static_cast<size_t>(j) * strideT9];
        }
    }
}
...
# pragma omp parallel for if(!sequential)
    ...
    for (int j = 0; j < C.n(); ++j) {
        for (int i = 0; i < C.m(); ++i) {
            dataC[i + static_cast<size_t>(j) * strideC] = Scalar(-0.5) * dataT1[i + static_cast<size_t>(j) * strideT1] + Scalar(-0.5) * dataT2[i + static_cast<size_t>(j) * strideT2] + Scalar(0.5) * dataT3[i + static_cast<size_t>(j) * strideT3] + Scalar(-0.5) * dataT4[i + static_cast<size_t>(j) * strideT4] + Scalar(0.5) * dataT5[i + static_cast<size_t>(j) * strideT5] + Scalar(-0.5) * dataT6[i + static_cast<size_t>(j) * strideT6] + Scalar(-0.5) * dataT7[i + static_cast<size_t>(j) * strideT7] + Scalar(0.5) * dataT8[i + static_cast<size_t>(j) * strideT8] + Scalar(0.5) * dataT9[i + static_cast<size_t>(j) * strideT9] + Scalar(-0.5) * dataT10[i + static_cast<size_t>(j) * strideT10];
        }
    }
}
...
# pragma omp parallel for if(!sequential)
        ...
        for (int j = 0; j < C.n(); ++j) {
            for (int i = 0; i < C.m(); ++i) {
                dataC[i + static_cast<size_t>(j) * strideC] = Scalar(-0.5) * dataM1[i + static_cast<size_t>(j) * strideM1] + Scalar(0.5) * dataM2[i + static_cast<size_t>(j) * strideM2] + Scalar(-0.5) * dataM3[i + static_cast<size_t>(j) * strideM3] + Scalar(-0.5) * dataM4[i + static_cast<size_t>(j) * strideM4] + Scalar(0.5) * dataM5[i + static_cast<size_t>(j) * strideM5] + Scalar(-0.5) * dataM6[i + static_cast<size_t>(j) * strideM6] + Scalar(-0.5) * dataM7[i + static_cast<size_t>(j) * strideM7] + Scalar(-0.5) * dataM8[i + static_cast<size_t>(j) * strideM8] + Scalar(-0.5) * dataM9[i + static_cast<size_t>(j) * strideM9] + Scalar(-0.5) * dataM10[i + static_cast<size_t>(j) * strideM10] + Scalar(0.5) * dataM11[i + static_cast<size_t>(j) * strideM11] + Scalar(0.5) * dataM12[i + static_cast<size_t>(j) * strideM12] + Scalar(-0.5) * dataM13[i + static_cast<size_t>(j) * strideM13] + Scalar(-0.5) * dataM14[i + static_cast<size_t>(j) * strideM14] + Scalar(-0.5) * dataM15[i + static_cast<size_t>(j) * strideM15] + Scalar(-0.5) * dataM16[i + static_cast<size_t>(j) * strideM16] + Scalar(-0.5) * dataM17[i + static_cast<size_t>(j) * strideM17] + Scalar(0.5) * dataM18[i + static_cast<size_t>(j) * strideM18] + Scalar(-0.5) * dataM19[i + static_cast<size_t>(j) * strideM19] + Scalar(-0.5) * dataM20[i + static_cast<size_t>(j) * strideM20] + Scalar(0.5) * dataM21[i + static_cast<size_t>(j) * strideM21] + Scalar(0.5) * dataM22[i + static_cast<size_t>(j) * strideM22] + Scalar(0.5) * dataM23[i + static_cast<size_t>(j) * strideM23] + Scalar(0.5) * dataM24[i + static_cast<size_t>(j) * strideM24] + beta * dataC[i + static_cast<size_t>(j) * strideC];
            }
        }
    } else {
#ifdef _PARALLEL_
# pragma omp parallel for if(!sequential)
        ...
        for (int j = 0; j < C.n(); ++j) {
            for (int i = 0; i < C.m(); ++i) {
                dataC[i + static_cast<size_t>(j) * strideC] = Scalar(-0.5) * dataM1[i + static_cast<size_t>(j) * strideM1] + Scalar(0.5) * dataM2[i + static_cast<size_t>(j) * strideM2] + Scalar(-0.5) * dataM3[i + static_cast<size_t>(j) * strideM3] + Scalar(-0.5) * dataM4[i + static_cast<size_t>(j) * strideM4] + Scalar(0.5) * dataM5[i + static_cast<size_t>(j) * strideM5] + Scalar(-0.5) * dataM6[i + static_cast<size_t>(j) * strideM6] + Scalar(-0.5) * dataM7[i + static_cast<size_t>(j) * strideM7] + Scalar(-0.5) * dataM8[i + static_cast<size_t>(j) * strideM8] + Scalar(-0.5) * dataM9[i + static_cast<size_t>(j) * strideM9] + Scalar(-0.5) * dataM10[i + static_cast<size_t>(j) * strideM10] + Scalar(0.5) * dataM11[i + static_cast<size_t>(j) * strideM11] + Scalar(0.5) * dataM12[i + static_cast<size_t>(j) * strideM12] + Scalar(-0.5) * dataM13[i + static_cast<size_t>(j) * strideM13] + Scalar(-0.5) * dataM14[i + static_cast<size_t>(j) * strideM14] + Scalar(-0.5) * dataM15[i + static_cast<size_t>(j) * strideM15] + Scalar(-0.5) * dataM16[i + static_cast<size_t>(j) * strideM16] + Scalar(-0.5) * dataM17[i + static_cast<size_t>(j) * strideM17] + Scalar(0.5) * dataM18[i + static_cast<size_t>(j) * strideM18] + Scalar(-0.5) * dataM19[i + static_cast<size_t>(j) * strideM19] + Scalar(-0.5) * dataM20[i + static_cast<size_t>(j) * strideM20] + Scalar(0.5) * dataM21[i + static_cast<size_t>(j) * strideM21] + Scalar(0.5) * dataM22[i + static_cast<size_t>(j) * strideM22] + Scalar(0.5) * dataM23[i + static_cast<size_t>(j) * strideM23] + Scalar(0.5) * dataM24[i + static_cast<size_t>(j) * strideM24];
            }
        }
    }
}
...
# pragma omp parallel for if(!sequential)
        ...
        for (int j = 0; j < C.n(); ++j) {
            for (int i = 0; i < C.m(); ++i) {
                dataC[i + static_cast<size_t>(j) * strideC] = Scalar(-0.5) * dataM1[i + static_cast<size_t>(j) * strideM1] + Scalar(0.5) * dataM2[i + static_cast<size_t>(j) * strideM2] + Scalar(-0.5) * dataM3[i + static_cast<size_t>(j) * strideM3] + Scalar(0.5) * dataM4[i + static_cast<size_t>(j) * strideM4] + Scalar(0.5) * dataM5[i + static_cast<size_t>(j) * strideM5] + Scalar(-0.5) * dataM6[i + static_cast<size_t>(j) * strideM6] + Scalar(-0.5) * dataM7[i + static_cast<size_t>(j) * strideM7] + Scalar(-0.5) * dataM8[i + static_cast<size_t>(j) * strideM8] + Scalar(0.5) * dataM9[i + static_cast<size_t>(j) * strideM9] + Scalar(0.5) * dataM10[i + static_cast<size_t>(j) * strideM10] + Scalar(0.5) * dataM11[i + static_cast<size_t>(j) * strideM11] + Scalar(0.5) * dataM12[i + static_cast<size_t>(j) * strideM12] + Scalar(-0.5) * dataM13[i + static_cast<size_t>(j) * strideM13] + Scalar(0.5) * dataM14[i + static_cast<size_t>(j) * strideM14] + Scalar(-0.5) * dataM15[i + static_cast<size_t>(j) * strideM15] + Scalar(0.5) * dataM16[i + static_cast<size_t>(j) * strideM16] + beta * dataC[i + static_cast<size_t>(j) * strideC];
            }
        }
    } else {
#ifdef _PARALLEL_
# pragma omp parallel for if(!sequential)
        ...
        for (int j = 0; j < C.n(); ++j) {
            for (int i = 0; i < C.m(); ++i) {
                dataC[i + static_cast<size_t>(j) * strideC] = Scalar(-0.5) * dataM1[i + static_cast<size_t>(j) * strideM1] + Scalar(0.5) * dataM2[i + static_cast<size_t>(j) * strideM2] + Scalar(-0.5) * dataM3[i + static_cast<size_t>(j) * strideM3] + Scalar(0.5) * dataM4[i + static_cast<size_t>(j) * strideM4] + Scalar(0.5) * dataM5[i + static_cast<size_t>(j) * strideM5] + Scalar(-0.5) * dataM6[i + static_cast<size_t>(j) * strideM6] + Scalar(-0.5) * dataM7[i + static_cast<size_t>(j) * strideM7] + Scalar(-0.5) * dataM8[i + static_cast<size_t>(j) * strideM8] + Scalar(0.5) * dataM9[i + static_cast<size_t>(j) * strideM9] + Scalar(0.5) * dataM10[i + static_cast<size_t>(j) * strideM10] + Scalar(0.5) * dataM11[i + static_cast<size_t>(j) * strideM11] + Scalar(0.5) * dataM12[i + static_cast<size_t>(j) * strideM12] + Scalar(-0.5) * dataM13[i + static_cast<size_t>(j) * strideM13] + Scalar(0.5) * dataM14[i + static_cast<size_t>(j) * strideM14] + Scalar(-0.5) * dataM15[i + static_cast<size_t>(j) * strideM15] + Scalar(0.5) * dataM16[i + static_cast<size_t>(j) * strideM16];
            }
        }
    }
}
...
void FastMatmulRecursive(LockAndCounter& locker, MemoryManager<Scalar>& mem_mngr, Matrix<Scalar>& A, Matrix<Scalar>& B, Matrix<Scalar>& C, int total_steps, int steps_left, int start_index, double x, int num_threads, Scalar beta) {
    ...
    // M1 = (0.5 * A11 + 0.5 * A13 + 0.5 * A22 + 0.5 * A23 + -0.5 * A31 + 0.5 * A32) * (-0.5 * B12 + 0.5 * B15 + 0.5 * B16 + 0.5 * B23 + 0.5 * B24 + -0.5 * B25 + -0.5 * B31 + 0.5 * B33 + 0.5 * B36)
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
...
# endif
    ...
    // M2 = (0.5 * A11 + -0.5 * A13 + 0.5 * A22 + -0.5 * A23 + -0.5 * A31 + 0.5 * A32) * (-0.5 * B13 + -0.5 * B14 + -0.5 * B15 + 0.5 * B22 + 0.5 * B25 + -0.5 * B26 + -0.5 * B31 + -0.5 * B32 + 0.5 * B34)
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
...
# endif
    ...
    // M3 = (-0.5 * A11 + -0.5 * A13 + 0.5 * A22 + -0.5 * A23 + 0.5 * A31 + 0.5 * A32) * (-0.5 * B11 + 0.5 * B13 + -0.5 * B16 + -0.5 * B21 + 0.5 * B22 + 0.5 * B24 + -0.5 * B32 + 0.5 * B35 + -0.5 * B36)
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
...
# endif
    ...
    // M4 = (-0.5 * A11 + 0.5 * A13 + -0.5 * A22 + -0.5 * A23 + 0.5 * A31 + 0.5 * A32) * (-0.5 * B12 + -0.5 * B15 + -0.5 * B16 + -0.5 * B23 + 0.5 * B24 + -0.5 * B25 + -0.5 * B31 + -0.5 * B33 + 0.5 * B36)
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
...
# endif
    ...
    // M5 = (0.5 * A11 + 0.5 * A13 + 0.5 * A22 + -0.5 * A23 + -0.5 * A31 + -0.5 * A32) * (-0.5 * B13 + 0.5 * B14 + 0.5 * B15 + -0.5 * B22 + 0.5 * B25 + -0.5 * B26 + -0.5 * B31 + 0.5 * B32 + 0.5 * B34)
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
...
# endif
    ...
    // M6 = (-0.5 * A11 + 0.5 * A13 + 0.5 * A22 + -0.5 * A23 + -0.5 * A31 + 0.5 * A32) * (-0.5 * B11 + -0.5 * B12 + 0.5 * B14 + 0.5 * B21 + 0.5 * B23 + 0.5 * B26 + -0.5 * B33 + -0.5 * B34 + -0.5 * B35)
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
...
# endif
    ...
    // M7 = (-0.5 * A11 + -0.5 * A13 + 0.5 * A22 + 0.5 * A23 + -0.5 * A31 + 0.5 * A32) * (-0.5 * B11 + 0.5 * B13 + 0.5 * B16 + 0.5 * B21 + -0.5 * B22 + 0.5 * B24 + -0.5 * B32 + 0.5 * B35 + 0.5 * B36)
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
...
# endif
    ...
    // M8 = (0.5 * A11 + 0.5 * A13 + 0.5 * A22 + -0.5 * A23 + 0.5 * A31 + 0.5 * A32) * (0.5 * B12 + -0.5 * B15 + 0.5 * B16 + 0.5 * B23 + -0.5 * B24 + -0.5 * B25 + 0.5 * B31 + -0.5 * B33 + 0.5 * B36)
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
...
# endif
    ...
    // M9 = (-0.5 * A11 + 0.5 * A13 + 0.5 * A22 + -0.5 * A23 + 0.5 * A31 + -0.5 * A32) * (-0.5 * B11 + -0.5 * B13 + -0.5 * B16 + 0.5 * B21 + 0.5 * B22 + -0.5 * B24 + -0.5 * B32 + -0.5 * B35 + 0.5 * B36)
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
...
# endif
    ...
    // M10 = (-0.5 * A11 + -0.5 * A13 + 0.5 * A22 + 0.5 * A23 + 0.5 * A31 + -0.5 * A32) * (-0.5 * B11 + 0.5 * B12 + -0.5 * B14 + 0.5 * B21 + -0.5 * B23 + -0.5 * B26 + -0.5 * B33 + -0.5 * B34 + 0.5 * B35)
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
...
# endif
    ...
    // M11 = (0.5 * A11 + 0.5 * A13 + -0.5 * A22 + 0.5 * A23 + 0.5 * A31 + 0.5 * A32) * (-0.5 * B11 + 0.5 * B12 + 0.5 * B14 + -0.5 * B21 + 0.5 * B23 + -0.5 * B26 + -0.5 * B33 + 0.5 * B34 + 0.5 * B35)
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
...
# endif
    ...
    // M12 = (0.5 * A11 + 0.5 * A13 + 0.5 * A22 + 0.5 * A23 + 0.5 * A31 + -0.5 * A32) * (-0.5 * B13 + -0.5 * B14 + 0.5 * B15 + 0.5 * B22 + -0.5 * B25 + -0.5 * B26 + -0.5 * B31 + 0.5 * B32 + -0.5 * B34)
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
...
# endif
    ...
    // M13 = (-0.5 * A11 + 0.5 * A13 + -0.5 * A22 + 0.5 * A23 + -0.5 * A31 + 0.5 * A32) * (-0.5 * B12 + -0.5 * B15 + 0.5 * B16 + 0.5 * B23 + 0.5 * B24 + 0.5 * B25 + -0.5 * B31 + -0.5 * B33 + -0.5 * B36)
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
...
# endif
    ...
    // M14 = (-0.5 * A11 + 0.5 * A13 + 0.5 * A22 + 0.5 * A23 + -0.5 * A31 + -0.5 * A32) * (0.5 * B11 + 0.5 * B13 + -0.5 * B16 + 0.5 * B21 + 0.5 * B22 + 0.5 * B24 + 0.5 * B32 + 0.5 * B35 + 0.5 * B36)
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
...
# endif
    ...
    // M15 = (-0.5 * A11 + 0.5 * A13 + 0.5 * A22 + 0.5 * A23 + 0.5 * A31 + 0.5 * A32) * (0.5 * B11 + 0.5 * B12 + 0.5 * B14 + 0.5 * B21 + 0.5 * B23 + -0.5 * B26 + 0.5 * B33 + -0.5 * B34 + 0.5 * B35)
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
...
# endif
    ...
    // M16 = (0.5 * A11 + -0.5 * A13 + 0.5 * A22 + 0.5 * A23 + 0.5 * A31 + 0.5 * A32) * (0.5 * B13 + -0.5 * B14 + 0.5 * B15 + 0.5 * B22 + 0.5 * B25 + 0.5 * B26 + 0.5 * B31 + 0.5 * B32 + 0.5 * B34)
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
...
# endif
    ...
    // M17 = (-0.5 * A21 + -0.5 * A22 + -0.5 * A31 + -0.5 * A32) * (-0.5 * B11 + -0.5 * B12 + 0.5 * B13 + -0.5 * B14 + 0.5 * B15 + -0.5 * B16 + -0.5 * B21 + 0.5 * B25 + 0.5 * B34 + -0.5 * B36)
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
...
# endif
    ...
    // M18 = (0.5 * A11 + 0.5 * A12 + -0.5 * A31 + -0.5 * A32) * (-0.5 * B11 + -0.5 * B15 + -0.5 * B21 + 0.5 * B22 + -0.5 * B23 + 0.5 * B24 + -0.5 * B25 + 0.5 * B26 + -0.5 * B32 + -0.5 * B33)
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
...
# endif
    ...
    // M19 = (-0.5 * A21 + 0.5 * A22 + -0.5 * A31 + 0.5 * A32) * (-0.5 * B11 + -0.5 * B12 + 0.5 * B13 + 0.5 * B14 + 0.5 * B15 + 0.5 * B16 + 0.5 * B21 + -0.5 * B25 + -0.5 * B34 + 0.5 * B36)
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
...
# endif
    ...
    // M20 = (0.5 * A12 + 0.5 * A13 + 0.5 * A22 + 0.5 * A23) * (0.5 * B11 + 0.5 * B15 + 0.5 * B21 + 0.5 * B22 + 0.5 * B23 + 0.5 * B24 + -0.5 * B25 + -0.5 * B26 + 0.5 * B32 + 0.5 * B33)
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
...
# endif
    ...
    // M21 = (-0.5 * A11 + 0.5 * A13 + 0.5 * A21 + -0.5 * A23) * (0.5 * B11 + 0.5 * B12 + 0.5 * B13 + -0.5 * B14 + 0.5 * B15 + 0.5 * B16 + -0.5 * B21 + 0.5 * B25 + 0.5 * B34 + -0.5 * B36)
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
...
# endif
    ...
    // M22 = (-0.5 * A11 + -0.5 * A13 + -0.5 * A21 + -0.5 * A23) * (0.5 * B11 + -0.5 * B12 + -0.5 * B13 + -0.5 * B14 + 0.5 * B15 + 0.5 * B16 + 0.5 * B21 + -0.5 * B25 + -0.5 * B34 + 0.5 * B36)
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
...
# endif
    ...
    // M23 = (-0.5 * A22 + 0.5 * A23 + -0.5 * A32 + 0.5 * A33) * (0.5 * B14 + 0.5 * B16 + -0.5 * B22 + 0.5 * B23 + 0.5 * B31 + 0.5 * B32 + -0.5 * B33 + -0.5 * B34 + -0.5 * B35 + 0.5 * B36)
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
...
# endif
    ...
    // M24 = (-0.5 * A22 + -0.5 * A23 + -0.5 * A32 + -0.5 * A33) * (0.5 * B14 + 0.5 * B16 + -0.5 * B22 + 0.5 * B23 + -0.5 * B31 + -0.5 * B32 + 0.5 * B33 + -0.5 * B34 + 0.5 * B35 + 0.5 * B36)
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
...
# endif
    ...
    // M25 = (-0.5 * A11 + 0.5 * A12 + 0.5 * A31 + -0.5 * A32) * (0.5 * B11 + 0.5 * B15 + -0.5 * B21 + -0.5 * B22 + 0.5 * B23 + 0.5 * B24 + -0.5 * B25 + 0.5 * B26 + 0.5 * B32 + 0.5 * B33)
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
...
# endif
    ...
    // M26 = (-0.5 * A12 + 0.5 * A13 + 0.5 * A22 + -0.5 * A23) * (-0.5 * B11 + -0.5 * B15 + 0.5 * B21 + 0.5 * B22 + 0.5 * B23 + -0.5 * B24 + -0.5 * B25 + 0.5 * B26 + -0.5 * B32 + -0.5 * B33)
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
...
# endif
    ...
    // M27 = (0.5 * A11 + 0.5 * A13 + -0.5 * A31 + -0.5 * A33) * (0.5 * B14 + 0.5 * B16 + -0.5 * B22 + 0.5 * B23 + -0.5 * B31 + 0.5 * B32 + 0.5 * B33 + 0.5 * B34 + -0.5 * B35 + 0.5 * B36)
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
...
# endif
    ...
    // M28 = (-0.5 * A11 + -0.5 * A13 + -0.5 * A31 + -0.5 * A33) * (0.5 * B14 + 0.5 * B16 + -0.5 * B22 + 0.5 * B23 + 0.5 * B31 + -0.5 * B32 + -0.5 * B33 + 0.5 * B34 + 0.5 * B35 + 0.5 * B36)
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
...
# endif
    ...
    // M29 = (0.5 * A11 + -0.5 * A13 + 0.5 * A31 + -0.5 * A33) * (0.5 * B14 + 0.5 * B16 + -0.5 * B22 + 0.5 * B23 + -0.5 * B31 + -0.5 * B32 + -0.5 * B33 + -0.5 * B34 + -0.5 * B35 + -0.5 * B36)
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
...
# endif
    ...
    // M30 = (0.5 * A22 + -0.5 * A23 + -0.5 * A32 + 0.5 * A33) * (0.5 * B14 + 0.5 * B16 + -0.5 * B22 + 0.5 * B23 + -0.5 * B31 + 0.5 * B32 + -0.5 * B33 + 0.5 * B34 + 0.5 * B35 + -0.5 * B36)
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
...
# endif
    ...
    // M31 = (-0.5 * A22 + -0.5 * A23 + 0.5 * A32 + 0.5 * A33) * (0.5 * B14 + 0.5 * B16 + -0.5 * B22 + 0.5 * B23 + 0.5 * B31 + -0.5 * B32 + 0.5 * B33 + 0.5 * B34 + -0.5 * B35 + -0.5 * B36)
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
...
# endif
    ...
    // M32 = (0.5 * A11 + -0.5 * A13 + -0.5 * A31 + 0.5 * A33) * (0.5 * B14 + 0.5 * B16 + -0.5 * B22 + 0.5 * B23 + 0.5 * B31 + 0.5 * B32 + 0.5 * B33 + -0.5 * B34 + 0.5 * B35 + -0.5 * B36)
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
...
# endif
    ...
    // M33 = (0.5 * A11 + -0.5 * A12 + 0.5 * A31 + -0.5 * A32) * (-0.5 * B11 + -0.5 * B15 + 0.5 * B21 + -0.5 * B22 + 0.5 * B23 + 0.5 * B24 + 0.5 * B25 + 0.5 * B26 + -0.5 * B32 + -0.5 * B33)
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
...
# endif
    ...
    // M34 = (0.5 * A11 + -0.5 * A13 + 0.5 * A21 + -0.5 * A23) * (0.5 * B11 + 0.5 * B12 + 0.5 * B13 + 0.5 * B14 + 0.5 * B15 + -0.5 * B16 + 0.5 * B21 + -0.5 * B25 + -0.5 * B34 + 0.5 * B36)
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
...
# endif
    ...
    // M35 = (0.5 * A12 + -0.5 * A13 + 0.5 * A22 + -0.5 * A23) * (-0.5 * B11 + -0.5 * B15 + -0.5 * B21 + 0.5 * B22 + 0.5 * B23 + 0.5 * B24 + 0.5 * B25 + -0.5 * B26 + -0.5 * B32 + -0.5 * B33)
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
...
# endif
    ...
    // M36 = (0.5 * A11 + 0.5 * A12 + 0.5 * A31 + 0.5 * A32) * (-0.5 * B11 + -0.5 * B15 + -0.5 * B21 + -0.5 * B22 + 0.5 * B23 + -0.5 * B24 + -0.5 * B25 + -0.5 * B26 + -0.5 * B32 + -0.5 * B33)
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
...
# endif
    ...
    // M37 = (-0.5 * A21 + 0.5 * A22 + 0.5 * A31 + -0.5 * A32) * (-0.5 * B11 + 0.5 * B12 + -0.5 * B13 + -0.5 * B14 + 0.5 * B15 + -0.5 * B16 + 0.5 * B21 + -0.5 * B25 + -0.5 * B34 + 0.5 * B36)
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
...
# endif
    ...
    // M38 = (-0.5 * A21 + -0.5 * A22 + 0.5 * A31 + 0.5 * A32) * (0.5 * B11 + -0.5 * B12 + 0.5 * B13 + -0.5 * B14 + -0.5 * B15 + -0.5 * B16 + 0.5 * B21 + -0.5 * B25 + -0.5 * B34 + 0.5 * B36)
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
...
# endif
    ...
    // M39 = (-0.5 * A12 + -0.5 * A13 + 0.5 * A22 + 0.5 * A23) * (0.5 * B11 + 0.5 * B15 + -0.5 * B21 + 0.5 * B22 + 0.5 * B23 + -0.5 * B24 + 0.5 * B25 + 0.5 * B26 + 0.5 * B32 + 0.5 * B33)
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
...
# endif
    ...
    // M40 = (-0.5 * A11 + -0.5 * A13 + 0.5 * A21 + 0.5 * A23) * (-0.5 * B11 + 0.5 * B12 + 0.5 * B13 + -0.5 * B14 + -0.5 * B15 + 0.5 * B16 + 0.5 * B21 + -0.5 * B25 + -0.5 * B34 + 0.5 * B36)
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
